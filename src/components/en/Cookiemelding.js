		...
		<div className="cookie">
			<div className="cookieBlock">
				...
				<p>
					...
					gebruiken zonder de functionele cookies te accepteren. Met de analytische cookie kunnen we zien hoe vaak de
					Woo-generator gebruikt wordt. Wij vinden dit belangrijk voor de verbetering van de Woo-generator.
				</p>
				<br />
				<p>
					...
					nogmaals: de informatie die jij hebt ingevuld of aangeklikt wordt niet opgeslagen door de beheerders. De
					beheerders kunnen ook niet zien wat je hebt ingevuld of aangeklikt.
					<br />
					<br />
				</p>
