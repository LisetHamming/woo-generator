const DataText = state => [
  ...
  {
    id: 4,
    title: "Possibly extensive request",
    sentence:
      "If my request is so extensive that you cannot reasonably complete it within the legal deadline, I request you to inform me within two weeks and provide me with an index or overview of the discovered documents within four weeks. This way, we can collaboratively select the documents I actually wish to receive and make agreements on the order and timeframe for providing them. With this suggestion, I hope to save you unnecessary work."
  },
  {
    id: 5,
  ...
  {
    id: 7,
    title: "Summaries of documents",
    sentence:
      "If you cannot make documents public, I alternatively request a concise representation of the content or a summary."
  },
  {
    id: 8,
  ...
  {
    id: 9,
    title: "Preference for digital provision",
    sentence:
      "I request you to provide the requested information that is digitally available to you in digital form. The information that is only analog ('hard copy') in your archive, I prefer to receive in digital form, and otherwise a copy. If you intend to charge for this, I request you to contact me in advance specifying the amount."
  },
  {
    id: 10,
