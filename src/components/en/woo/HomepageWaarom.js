		...
		<div className="sectionWaarom">
			<div className="sectionBlock">
				<div>
					...
					<p>
						Everyone has the right to request information contained in documents from the government. The Open
						Government Act ("Woo") regulates what such a request must meet. A Woo request is crucial to access
						information that the government does not disclose voluntarily. Check{" "}
				...
				<div>
					...
					<p>
						Drafting a Woo request is not difficult, but the request must meet a number of conditions. With the Woo
						generator, we help you draft a proper and valid Woo request. Choose which documents you want to request and
						from which government agency. We have compiled the first easily searchable list of government agencies in
						the Netherlands subject to the Woo. Done! You can now save your Woo request and send it by mail or
						digitally.
					</p>
				</div>
				<div>
					...
					<p>
						Quite a few journalists think filing a Woo request is a mysterious legal trick. That is exaggerated, but
						there is a grain of truth to it: there are quite a few points to watch out for. With the Woo generator, you
						don't have to worry about overlooking anything. Get started!
					</p>
				</div>
				<div>
					<h1 className="scribble" style={{ backgroundImage: `url(${bg})` }}>
					...
					<p>
						You use a Woo request only for documents that are not yet public. Before you submit a Woo request, you
