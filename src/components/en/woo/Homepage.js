		...
		<div>
			...
			<div className="homepageBlock">
				<div className="blockText">
					...
					<p>
						On May 1, 2022, the Freedom of Information Act (Wet openbaarheid van bestuur or Wob) was replaced by the
						Open Government Act (Wet open overheid or Woo).{" "}
					</p>{" "}
					<br></br>
					<p>
						As a result, the Wob generator has now become the Woo generator, and we have taken the opportunity to
						enhance the generator, including with this English translation. From now on, you should submit a Woo request
						if you want to obtain government information from a government body in the (European) Netherlands.
					</p>
					...
					<div className="nextButtons">
						<Link to="/EN/woo/StapVoorAf" className="start" onClick={e => clickHandlerSetLaw("Woo")}>
							WOO
						</Link>
