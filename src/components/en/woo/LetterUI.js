				...
				<div>
					...
					{value.subjectMilieu ? (
						<span className="scribble">
							Because this request concerns the environment, in connection with the Aarhus Convention, regardless of any
							postponement, even when requesting the opinion of interested parties, you are required to make a final
							decision within eight weeks at the latest.
						</span>
					) : (
