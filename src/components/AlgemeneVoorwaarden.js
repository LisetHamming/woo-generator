        ...
        <div className="conditions">
            ...
            <div className="block2">
                <div>
                    ...
                    <p>Bij beëindiging komen alle licenties en andere rechten die op grond van deze Algemene Voorwaarden aan u zijn verleend, onmiddellijk te vervallen. <br /> Wij behouden ons het recht voor om de toegang tot de Dienst te weigeren voor elke willekeurige persoon op elk gewenst moment en om welke reden dan ook. <br/>U gaat akkoord dat u verantwoordelijk bent voor alle datakosten die u maakt door het gebruik van de Dienst. Wij verbieden ‘crawling’, ‘scraping’, ‘caching’ of op een andere wijze toegang verkrijgen tot de Dienst via geautomatiseerde middelen (behalve als gevolg van de standaard zoekmachine protocollen of technologieën gebruikt door een zoekmachine met uitdrukkelijke toestemming van VVOJ).</p>
                    <h2>Intellectuele eigendomsrechten</h2>
                    <p>VVOJ verleent aan u hierbij een niet-overdraagbare licentie om de Dienst te gebruiken. <br/> Het is niet toegestaan de broncode van de Dienst te wijzigen, er afgeleide werken van te maken, te decompileren of anderszins te verkrijgen, behalve wanneer dit uitdrukkelijk is toegestaan volgens een open-bronlicentie of wanneer we u uitdrukkelijk schriftelijke toestemming hebben gegeven. Elke poging om dit te doen, is een schending van de rechten van VVOJ. </p>
                    <p>De Dienst bevat inhoud die in eigendom of in licentie is bij VVOJ (“VVOJ Inhoud”). VVOJ Inhoud wordt beschermd door intellectuele eigendomsrechten, zoals auteursrechten en merkenrechten. VVOJ heeft en behoudt alle rechten ten aanzien van de VVOJ Inhoud. Het is niet toegestaan om enige kennisgeving inzake auteursrechten, handelsmerken of andere intellectuele eigendomsrechten die zijn opgenomen in of bij de VVOJ Inhoud te verwijderen, aan te passen of te verhullen. Evenmin is het toegestaan om VVOJ Inhoud te reproduceren, te wijzigen, aan te passen, uit te voeren, weer te geven, te publiceren, te verspreiden, over te brengen, uit te zenden, te verkopen, in licentie te verlenen of op enigerlei andere wijze te exploiteren, noch er afgeleide werken van te maken.</p>
                    <p>De VVOJ naam en logo zijn handelsmerken van VVOJ, en mogen niet geheel of gedeeltelijk worden gekopieerd, geïmiteerd of gebruikt worden zonder voorafgaande schriftelijke toestemming van VVOJ. Daarnaast mogen alle koppen, aangepaste afbeeldingen, knoppictogrammen en scripts servicemerken, handelsmerken en/of beeldmerken van VVOJ zonder voorafgaande schriftelijke toestemming van VVOJ, niet worden gekopieerd, geïmiteerd of gebruikt. </p>
                    <h2>Derden</h2>
                    <p>De Dienst of communicatie die u ontvangt van de Dienst, kunnen links naar (mobiele) applicaties, websites of functies van derden bevatten. De Dienst kan ook de inhoud van derden bevatten die wij niet goedkeuren of aanbevelen. VVOJ controleert geen webdiensten of andere inhoud van deze derden. U erkent en aanvaardt uitdrukkelijk dat VVOJ op geen enkele wijze verantwoordelijk of aansprakelijk is voor dergelijke diensten of functies van derden. Wij raden u aan de voorwaarden en het privacy beleid van deze derden te lezen.</p>
                    <h2>Afwijzing van garanties</h2>
                    <p>De Dienst, inclusief VVOJ Inhoud, wordt geleverd op een “zoals deze is”, “zoals deze beschikbaar is” en “met alle aanwezige gebreken” basis. Voor zover toegestaan door de wet, geeft noch VVOJ noch haar bestuurders, werknemers, managers, officers, partners, filialen of agenten (gezamenlijk de “VVOJ Partijen”) enige garantie of goedkeuring van welke aard dan ook, expliciet of impliciet, met betrekking tot: (a) de Dienst; (b) de VVOJ Inhoud; (c) Gebruikers Inhoud; of (d) de veiligheid in verband met de overdracht van informatie naar VVOJ of via de Dienst. Bovendien wijzen de VVOJ Partijen hierbij alle expliciete en impliciete garanties af, met inbegrip van, maar niet beperkt tot garanties van verkoopbaarheid, geschiktheid voor een bepaald doel, niet-inbreukmakendheid, eigendom, maatwerk, handel, rustig genot, systeemintegratie en afwezigheid van computervirussen. </p>
