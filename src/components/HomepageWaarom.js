		...
		<div className="sectionWaarom">
			...
			<div className="sectionBlock">
				<div>
					...
					<p>
						Iedereen heeft het recht om informatie op te vragen bij de overheid. Dat noemen we een Wob-verzoek. In de
						Wet openbaarheid van bestuur, afgekort: de Wob, is geregeld waar zo’n verzoek aan moet voldoen. Het doen van
						dit verzoek wordt vaak ‘wobben’ genoemd.
					</p>
				</div>
				<div>
					...
					<p>
						...
						versturen via de post of digitaal verzenden via de Wob - Knop.{" "}
					</p>
				</div>
			</div>
		</div>
