	...
	return (
		<div className="formLetter">
			...
			<p className="hidePrint">
				Hoewel de Wob BES-generator met de grootste zorgvuldigheid is ontwikkeld, is het opstellen van een goed Wob
				BES-verzoek mensenwerk en maatwerk. Bovendien blijf je zelf verantwoordelijk voor wat je naar het bestuursorgaan
				stuurt.
				<br />
				<br />
			</p>
			...
			<p>
				...
				opgeslagen. Ben je tevreden, druk de brief dan af en zet je handtekening eronder. Vergeet niet vóór het
				versturen per post een kopie van je ondertekende brief te maken.
				<br />
				<br />
				Digitaal versturen?
				<br />
				De Wob BES zegt niks over digitale indiening, omdat het gebaseerd is op de oude Wob. Die zei ook niks over
				digitale indiening. Dat is pas in de Woo gekomen. Check dus altijd van tevoren of het bestuursorgaan op het
				BES-eiland waar je het verzoek indient digitaal indienen toestaat. Als het niet mogelijk is, dan zou je je
				verzoek dan per brief moeten doen.
			</p>
			<br />
			<div>
				<p>
