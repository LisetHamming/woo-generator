const DataText = state => [
	...
	},
	{
		...
		sentence:
			"Mocht u vragen hebben over de precieze interpretatie of de gewenste afhandeling van dit verzoek, dan ben ik graag bereid een nadere toelichting te geven. Ik verzoek u hierover zo spoedig mogelijk maar uiterlijk binnen twee weken na ontvangst van mijn Wob BES-verzoek contact op te nemen."
	},
	{
		id: 3,
	...
	},
	{
		...
		sentence:
			"Bij gehele of gedeeltelijke weigering van een document verzoek ik u de weigering per document respectievelijk per alinea te motiveren. Niet alleen met verwijzing naar het betreffende Wob BES-artikel, maar tevens met onderbouwing waarom die weigeringsgrond zwaarder weegt dan het algemeen belang van openbaarheid."
	},
	{
		id: 9,
