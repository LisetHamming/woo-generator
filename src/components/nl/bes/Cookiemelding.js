	...
	return (
		<div className="cookie">
			<div className="cookieBlock">
				...
				<p>
					De Wob BES generator gebruikt alleen functionele cookies en een analytische cookie. Als je de functionele cookies
					uitzet, dan werkt de Wob BES generator niet: na het aanklikken van een optie of het invullen van een invulveld
					verschijnt dan bijvoorbeeld de bijbehorende alinea niet in de brief. Vandaar dat je de Wob BES generator niet kan
					gebruiken zonder de functionele cookies te accepteren. Met de analytische cookie kunnen we zien hoe vaak en
					waar in Nederland de Wob BES generator gebruikt wordt. Wij vinden dit belangrijk voor de verbetering van de
					Wob BES generator.
				</p>
				<br />
				<p>
					...
					informatie kan gebruiken om de Wob BES generator te laten werken. Dat is voor de tijd dat je je Wob BES verzoek aan
