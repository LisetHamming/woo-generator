	...
	return (
		<div className="cookie">
			<div className="cookieBlock">
				...
				<h1>Lob-generator gebruikt alleen functionele en analytische cookies</h1>
				<p>
					De Lob-generator gebruikt alleen functionele cookies en een analytische cookie. Als je de functionele cookies
					uitzet, dan werkt de Lob-generator niet: na het aanklikken van een optie of het invullen van een invulveld
					verschijnt dan bijvoorbeeld de bijbehorende alinea niet in de brief. Vandaar dat je de Lob-generator niet kan
					gebruiken zonder de functionele cookies te accepteren. Met de analytische cookie kunnen we zien hoe vaak en
					waar in Nederland de Lob-generator gebruikt wordt. Wij vinden dit belangrijk voor de verbetering van de
					Lob-generator.
				</p>
				<br />
				<p>
					...
					informatie kan gebruiken om de Lob-generator te laten werken. Dat is voor de tijd dat je je Lob-verzoek aan
