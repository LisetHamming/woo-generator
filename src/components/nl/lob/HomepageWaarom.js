		...
		<div className="sectionWaarom">
			<div className="sectionBlock">
				<div>
					...
					<p>
						Iedereen heeft het recht om informatie neergelegd in documenten op te vragen bij de overheid. In de
						Landsverordening openbaarheid van bestuur (de Lob) wordt dit geregeld. Elk van de (ei)landen in het
						Koninkrijk heeft een eigen versie van deze wet. Een Lob-verzoek is cruciaal om toegang te krijgen tot
				...
				<div>
					...
					<p>
						...
						of de overheid de documenten al openbaar gemaakt heeft. Tip: al openbaar gemaakte documenten kunnen je
						makkelijker de weg wijzen naar gerelateerd documenten die nog niet openbaar zijn gemaakt!{" "}
					</p>
					<br></br>
					<p>
