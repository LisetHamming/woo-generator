	...
	return (
		<div className="formLetter">
			...
			<p>
				...
				Het Vergunningloket ontvangt alle verzoeken in Curaçao en stuurt ze door naar het betreffende ministerie om een
				beslissing te nemen. Informeer altijd van tevoren bij het betreffende departement dat een digitaal verzoek kan
				worden ingediend om te voorkomen dat het verzoek wordt afgewezen.
			</p>
			<br />
			<div>
				<p>
