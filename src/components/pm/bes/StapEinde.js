	...
	return (
		<div className="formLetter">
			...
			<p>
				...
				mustra cu entrega un peticion via e-mail ta posibel. Semper informa di antemano na e departamento concerni con
				un peticion digital por wordo haci pa preveni cu e peticion no ta wordo acepta.
			</p>
			<br />
			<div>
				<p>
