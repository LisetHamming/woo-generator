	...
	return (
		<div className="formLetter">
			...
			<p className="hidePrint">
				Aunke e generado Lob ta traha cu hopi cuido, bo mes ta keda responsabel pa kico bo ta manda un instancia
				gubernamental.
				<br />
				<br />
			</p>
			...
			<p>
				...
				Si bo ta satisfecho, imprimi e carta y firm'e. Corda pa pidi un copia di bo carta ora bo entreg'e, of traha un
				copia prome cu bo mand'e via post.
				<br />
				<br />
				Manda digitalmente?
				<br />
				Aunke riba niun di e islanan ABCSSS e ley ta regla con un peticion mester wordo haci digitalmente, practica ta
				mustra cu entrega un peticion via e-mail ta posibel. Na Kòrsou por ehempel esaki ta bay via e{" "}
				<a
					className="plaintext"
				...
				Lokèt di Pèrmit ta ricibi tur peticion Lob na Kòrsou, y ta forward nan na e ministerio concerni pa bin cu un
				decision. Semper informa di antemano na e departamento concerni con un peticion digital por wordo haci pa
				preveni cu e peticion no ta wordo acepta.
			</p>
			<br />
			<div>
				<p>
